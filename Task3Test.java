...
class Task3Test {
  ...
  void mainError() {
    String[] args = {};
    IOException except = assertThrows(IOException.class, () -> Task3.main(args));
    assertEquals("java.io.IOException: Недостаточно аргументов в main", except.toString());
  }
  ...
  void findFile2() {
    ...
    assertEquals(
        "java.io.FileNotFoundException: Целевой файл является директорией", except.toString());
  }

  @Test
  void findFile3() throws IOException {
    String[] args = {
      ".\\src\\main\\java\\ru\\spbu\\apcyb\\svp\\",
      ".\\src\\main\\java\\ru\\spbu\\apcyb\\svp\\tasks\\res.txt"
    };
    Task3.main(args);
